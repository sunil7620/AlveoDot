...
void nrf_cal_init(void)
{
    ...
    defaultTime.dateTimeConfig.year = 2020;
    defaultTime.dateTimeConfig.month = 3;
    defaultTime.dateTimeConfig.day = 23;
    defaultTime.dateTimeConfig.hour = 11;
    defaultTime.dateTimeConfig.minute = 19;
    defaultTime.dateTimeConfig.second = 19;

    nrf_cal_set_time(&defaultTime);
}
...
void nrf_cal_set_time(timeStruct *tD)
{
    static time_t uncal_difftime, difftime, newtime;
    time_struct.tm_year = tD->dateTimeConfig.year - 1900;
    time_struct.tm_mon = tD->dateTimeConfig.month - 1;
    time_struct.tm_mday = tD->dateTimeConfig.day;
    time_struct.tm_hour = tD->dateTimeConfig.hour;
    time_struct.tm_min = tD->dateTimeConfig.minute;
    time_struct.tm_sec = tD->dateTimeConfig.second;   
...
time_t convertToTime_t(timeStruct *tD)
{
...
time_t getCurrentTime_t(void)
{
  return mktime(nrf_cal_get_time());
}